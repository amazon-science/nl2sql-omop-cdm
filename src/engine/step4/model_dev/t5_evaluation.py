...
# def do_inference(test_model, input_text):
#     """
...
#                                              max_length=test_model.hparams.max_input_length,
#                                              padding='max_length',
#                                              truncation=True,
#                                              return_tensors="pt")
...
#                     max_length=test_model.hparams.max_output_length,
#                     num_beams=2,
...
# def do_inference_v2(row, test_model):
#     """
#     Get inference of an input question based on the trained model.
#     Args:
...
# def do_inference_v3(model_test, val_df, name, device=1):
#     """
