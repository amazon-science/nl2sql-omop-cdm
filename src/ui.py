...
#         print(["{:s} (category: {:s})".format(d['Text'], cat_name) for cat_name, cat_dict in self.entities for d in cat_dict])
...
#         print('# of category entities before ', len(self.entities[category]))
...
#         print('# of category entities after ', len(self.entities[category]))
#         print("gets to display_main")        
        self._display_main()
        self._update_options()
